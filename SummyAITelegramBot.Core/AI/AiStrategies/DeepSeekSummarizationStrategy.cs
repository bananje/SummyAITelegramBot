...
public class DeepSeekSummarizationStrategy : ISummarizationStrategy
{
    ...
    public async Task<string> SummarizeAsync(string inputText)
    {
        ...
        var promt = "Представь, что ты встроен в чат Телеграмм бот, и выполняешь функцию сокращения постов до лаконичных кратких сводок. " +
            "\r\nВ сводку ты включаешь ключевое событие, действие, основного субъекта, важные цифры и даты." +
            "\r\nТы не дублируешь в сводке одинаковые события " +
            "\r\nТы не пропускаешь агрессивную и навязчивую рекламу.";
